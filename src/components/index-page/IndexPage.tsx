...
import { Heading, Paragraph, Button, Icon } from '@components'
      ...
      <section className="flex justify-center flex-grow w-full">
        <div className="grid grid-cols-2 flex-grow p-8 max-w-screen-xl pt-36 pb-16">
          <div className="flex flex-col items-start gap-8">
            <Heading className="text-slate-800">{t('index.header.title')}</Heading>
            <Paragraph className="text-slate-700 max-w-md">{t('index.header.description')}</Paragraph>
            <Button href={pathnames['about'][locale]}>{t('index.header.cta')}</Button>
          </div>
          <div className="flex">
      ...
      <section className="flex justify-center flex-grow w-full bg-slate-50">
        <div className="grid grid-cols-2 flex-grow py-16 px-8 max-w-screen-xl gap-10">
          <ul className="flex flex-col gap-4">
            <li className="flex flex-col gap-2 bg-white p-4">
              <Icon name="droplet" />
              <div>
          ...
          <div className="">
            <div className="sticky top-32 flex flex-col">
              <Heading level={2}>Welcome to plumbing</Heading>
              <Paragraph>
                ...
                A streamlined cloud solution. User generated content in real-time will have multiple touchpoints has evolved from generation X is on the runway heading towards a streamlined cloud solution.
              </Paragraph>
            </div>
          </div>
        </div>
